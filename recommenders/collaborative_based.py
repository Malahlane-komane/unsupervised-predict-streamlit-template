...
# Importing data
movies_df = pd.read_csv('https://raw.githubusercontent.com/TEAMCBB1/streamlit/main/movies.csv',sep = ',')
ratings_df = pd.read_csv('https://raw.githubusercontent.com/TEAMCBB1/streamlit/main/ratings.csv')
